...
const acciones = [
  { tipo: 'Cambiar', texto: 'Reemplazar el seguimiento fragmentado por validaciones interdisciplinarias digitales.' },
  { tipo: 'Crear', texto: 'Crear alertas automáticas ante inasistencias o riesgos nutricionales.' },
  { tipo: 'Crear', texto: 'Automatizar notificaciones preventivas para visitas domiciliarias prioritarias.' },
]
...
export default function SlideEstrategia2() {
  return (
    <div className="slide">
      ...
      <div style={{
        ...
        >
          ...
          <h1 style={{
            ...
            Estrategia 2 — <span className="gradient-text-blue">Modelo preventivo basado en datos</span>
          </h1>
          <p style={{
            fontFamily: 'var(--font-body)', fontSize: 'clamp(13px,1.4vw,16px)',
            color: 'var(--text-secondary)', lineHeight: 1.65, margin: 0, maxWidth: 820,
          }}>
            Implementar un modelo de análisis de datos interdisciplinario para anticipar situaciones
            de riesgo y fortalecer el enfoque preventivo.
          </p>
        </motion.div>
              ...
              {acciones.map((a, i) => (
                ...
                >
                  <span style={{
                    ...
                    color: 'var(--blue)', letterSpacing: '0.06em', flexShrink: 0, marginTop: 2,
                    background: 'rgba(37,99,235,0.10)', borderRadius: 6, padding: '2px 8px',
                  }}>{a.tipo}</span>
