...
const acciones = [
  { tipo: 'Cambiar', texto: 'Sustituir planillas Excel por una Historia Clínica Digital compartida en tiempo real.' },
  { tipo: 'Eliminar', texto: 'Eliminar duplicidad en la carga de datos socioeconómicos entre admisión y visita social.' },
  { tipo: 'Crear', texto: 'Crear un Portal de Acceso para Centros de Recuperación y hospitales adheridos.' },
]
...
export default function SlideEstrategia1() {
  return (
    <div className="slide">
      ...
      <div style={{
        ...
        >
          ...
          <h1 style={{
            ...
            Estrategia 1 — <span className="gradient-text">Transformación digital del proceso</span>
          </h1>
          <p style={{
              ...
              {acciones.map((a, i) => (
                ...
                >
                  <span style={{
                    ...
                    background: 'rgba(79,70,229,0.10)', borderRadius: 6, padding: '2px 8px',
                  }}>{a.tipo}</span>
